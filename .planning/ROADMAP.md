...
No active milestone is defined. Run `/gsd-new-milestone` to start the next milestone cycle.
...
Run `/gsd-new-milestone` when the next body of work is ready to define.
