...
- ✅ **v1.2 Project Story Pages** — Phases 10-13 shipped 2026-06-03. Archive: [v1.2-ROADMAP.md](v1.2-ROADMAP.md). Audit: [v1.2-MILESTONE-AUDIT.md](v1.2-MILESTONE-AUDIT.md).
...
- [x] `12-01-PLAN.md` — Project metadata, structured data, sitemap, social preview fallback, and verifier coverage
  **UI hint:** no
...
v1.2 is archived. Run `/gsd-new-milestone` to define the next milestone.
